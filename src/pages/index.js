  ...
  return (
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        <h1 className="hero__title" style={{background: "linear-gradient(315deg, rgb(146, 17, 137, 0.7) 3%, rgb(231, 211, 28, 0.7) 38%, rgb(67, 175, 73, 0.7) 68%, rgb(255, 29, 29, 0.7) 98%)" ,color: "black", textShadow: "4px 4px 8px rgba(253, 253, 253, 0.884)", padding:"3px", borderRadius:"10px"}}>{siteConfig.title}</h1>
